...
class SplitFrames(TabBase):
    ...
    def render_tab(self):
        ...
        with gr.Tab("Split Frames"):
            gr.Markdown(
                SimpleIcons.SPLIT_MERGE_SYMBOL + "Split large PNG sequences into processible chunks")
            ...
            with gr.Row():
                ...
                split_type = gr.Radio(value="Precise", label="Split Type",
                    ...
                    info="Choose 'Resynthesis' or 'Inflation' if split groups will be processed")
