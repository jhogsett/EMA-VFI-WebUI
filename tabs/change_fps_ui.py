...
class ChangeFPS(TabBase):
    ...
    def render_tab(self):
        ...
        starting_fps_fc.change(self.update_info_starting,
        ...
        ending_fps_fc.change(self.update_info_ending, inputs=[starting_fps_fc, ending_fps_fc, precision_fc],
            outputs=[output_lcm_text_fc, output_filler_text_fc, output_sampled_text_fc,
                times_output_fc, predictions_output_fc], show_progress=False)

        precision_fc.change(self.update_info_precision_fc, inputs=[starting_fps_fc, ending_fps_fc, precision_fc],
            outputs=[output_lcm_text_fc, output_filler_text_fc, output_sampled_text_fc,
                times_output_fc, predictions_output_fc], show_progress=False)
    ...
    def update_info_starting(self, starting_fps_fc, ending_fps_fc, precision_fc):
        return update_info_fc(starting_fps_fc, ending_fps_fc, precision_fc)

    def update_info_ending(self, starting_fps_fc, ending_fps_fc, precision_fc):
        return update_info_fc(starting_fps_fc, ending_fps_fc, precision_fc)

    def update_info_precision_fc(self, starting_fps_fc, ending_fps_fc, precision_fc):
        return update_info_fc(starting_fps_fc, ending_fps_fc, precision_fc)
