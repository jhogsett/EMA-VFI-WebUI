        ...
        with gr.Tab("Slice Video"):
            ...
            with gr.Row():
                output_path = gr.Text(max_lines=1, label="Output Path",
                    ...
                    info="Leave blank to store the sliced content in the group directories")
            ...
            with gr.Row():
                ...
                gif_frame_rate = gr.Slider(minimum=1, maximum=maximum_gif_fps, value=default_gif_fps,
                    step=0.01, label="Output GIF Frame Rate")
